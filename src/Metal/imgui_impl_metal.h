...
IMGUI_IMPL_API bool ImGui_ImplMetal_Init(id<MTLDevice> device, NSUInteger sampleCount, MTLPixelFormat colorPixelFormat, MTLPixelFormat depthPixelFormat, MTLPixelFormat stencilPixelFormat);
